...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<section class="content-header">
				<h1>
					Dashboard 등록 <small>관리자 </small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">관리자</li>
					<li class="active">Dashboard 등록</li>
				</ol>
			</section>
			<!-- 게시판 목록 -->
							...
							<div class="box box-default">
								...
								<div class="box-body">
									...
									<table class="table">
									    ...
									    <tr>
									         <th scope="row">
									         	<label for="dsb_no" class="">번호</label>
									         </th>
									          <td>
									        	<input id="dsb_no" name="dsb_no" type="text"
														class="form-control" >
									        </td>
									        <th scope="row">
									        	<label for="">Dashboard명</label>
									        </th>
									        <td>
									        	<input id="dsb_name" name="dsb_name" type="text"
														class="form-control" >
									        </td>
									    </tr>
									    <tr>
									        <th scope="row">
									        	<label for="dsb_x">가로사이즈</label>
									        </th>
									        <td>
									        	<input id="dsb_x" name="dsb_x" type="text"
														class="form-control" >
									        </td>
									         <th scope="row">
									         	<label for="dsb_y" class="">세로사이즈</label>
									         </th>
									          <td>
									        	<input id="dsb_y" name="dsb_y" type="text"
														class="form-control" >
									        </td>
									    </tr>
									    <tr>
									        <th scope="row">
									        	<label for="dsb_url">URL경로</label>
									        </th>
									        <td colspan="3">
									        	<input id="dsb_url" name="dsb_url" type="text"
														class="form-control" >
									        </td>
									    </tr>
									    <tr>
									        <th scope="row">
									        	<label for="dsb_ath_no">권한</label>
									        </th>
									        <td colspan="3">
									        	<input id="dsb_ath_no" name="dsb_ath_no" type="text"
														class="form-control" >
									        </td>
									    </tr>
							         </table>
