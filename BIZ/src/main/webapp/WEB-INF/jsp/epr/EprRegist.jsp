...
<body class="hold-transition skin-blue sidebar-mini" style="height:100%">
			...
			<section class="content-header">
				<h1>
					기업고객등록 <small>기업 </small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">기업/인물</li>
					<li class="active">기업</li>
				</ol>
			</section>
			<!-- 게시판 목록 -->
									...
									<table class="table">
									    ...
									    <tr>
									        ...
									        <td>
									         ...
									         <th scope="row">
									         	<label for="epr_rep_name" class="">대표자명</label>
									         </th>
									        <td>
									        	<input id="epr_rep_name" name="epr_rep_name"
															type="text" class="form-control" placeholder="대표자명"
															required>
											</td>
									    </tr>
									    <tr>
									     	<th scope="row">
									         	<label for="epr_tel_no" class="">전화번호</label>
									         </th>
									        <td>
									        	<input id="epr_tel_no" name="epr_tel_no"
															type="text" class="form-control" placeholder="전화번호"
															required>
											</td>
											<th scope="row">
									         	<label for="epr_biz_type" class="">업종</label>
									         </th>
									        <td>
												<select id="epr_biz_type"
								...
								<!-- board table -->
										<table class="table">
										    ...
										    <tr>
										        ...
										        <th scope="row">
										        	<label for="epr_addr">주소</label>
										        </th>
										        <td>
											        <input id="epr_addr" name="epr_addr"
										    ...
										    <tr>
										        <th scope="row">
										         	<label for="biz_num" class="">사업자번호</label>
										         </th>
										        <td>
										        	<input id="biz_num" name="biz_num"
																type="text" class="form-control" placeholder="사업자번호"
																required>
												</td>
												  <th scope="row">
										         	<label for="corp_regist_num" class="">법인등록번호</label>
										         </th>
										        <td>
										        	<input id="corp_regist_num" name="corp_regist_num"
																type="text" class="form-control" placeholder="법인등록번호"
																required>
												</td>
										    </tr>
										</table>
									...
									<div class="box box-default">
										<div class="box-header with-border">
											<div style="height:24px">
												<h3 class="box-title">기업내 인물</h3>
													<!--<a href='#' onClick='fn_write()' class="btn btn-success">글쓰기</a>-->
											</div>
										</div>
										<table
											class="table table-bordered table-striped table-hover text-center" style="height:150px;">
											<thead>
												<tr>
													<th style="width: 10%;text-align: center">팀명</th>
													<th style="width: 5%;text-align: center">직책</th>
													<th style="width: 5%;text-align: center">직급</th>
													<th style="width: 20%;text-align: center">이름</th>
													<!--<th>조회수</th>-->
												</tr>
											</thead>
											<tbody id="epr_emp_list">
												<!-- <tr>
								...
								<div class="box" style="width:49%;float:right;">
									<div class="box box-default">
										...
										<table
											...
											<thead>
												<tr>
													<th style="width: 40%;text-align: center">팀명</th>
													<th style="width: 60%;text-align: center">이름</th>
													<!--<th>조회수</th>-->
												</tr>
											</thead>
										</table>
	...
	<script type="text/javascript">
		...
		function registEpr(){
			...
			obj.epr_biz_type_cd = $("#epr_biz_type  option:selected").val();
		...
		function fn_addEmp(){
			...
			if(table.querySelector('td') == null){
				...
				html += '<td style="width:40%;text-align: center;font-weight:100;" value="C" contentEditable="true"></td>';
				html += '<td style="width:60%;text-align: center;font-weight:100;" contentEditable="true"></td>';
				html += '</tr>';
